...
BNB_DECLARE_SAMPLER_2D_ARRAY(14, 15, bnb_UVMORPH_FISHEYE);
#endif
...
#ifdef GLFX_LIGHTING
    var_n = mat3(bnb_MV)*(decode_int1010102(attrib_n).xyz*mat3(m));
#ifdef GLFX_TBN
    var_t = mat3(bnb_MV)*(decode_int1010102(attrib_t).xyz*mat3(m));
    var_b = decode_int1010102(attrib_t).w*cross( var_n, var_t );
#endif
